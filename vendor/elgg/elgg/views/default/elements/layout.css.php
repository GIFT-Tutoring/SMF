...
/***** TOPBAR ******/
.elgg-page-topbar {
	background: #3d3d3d;  url(<?= elgg_get_simplecache_url("toptoolbar_background.gif"); ?>) repeat-x top left; 
...
.elgg-page-header {
	padding: 0 10px;
	position: relative;
	background: #666666; <? /* url(<?= elgg_get_simplecache_url("header_shadow.png"); ?>) repeat-x bottom left; */ ?>
}
