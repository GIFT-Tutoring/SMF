...
.elgg-button-submit {
	...
	background: #ffc324 url(<?= elgg_get_simplecache_url("button_graduation.png"); ?>) repeat-x left 10px;
}
...
.elgg-button-submit:focus {
	...
	text-decoration: none;
	color: white;
	background:#ffdc73 url(<?= elgg_get_simplecache_url("button_graduation.png"); ?>) repeat-x left 10px;
}
